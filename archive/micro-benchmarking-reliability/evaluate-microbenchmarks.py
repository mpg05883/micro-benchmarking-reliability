...
parser.add_argument("--fixed_target_models", type=str, default=None)


def separate_subtasks_loop(
    args,
    arg_string,
    all_source_models,
    all_target_models,
    ...
    for ds in args.datasets_to_run:
        # load data
        all_data = np.load(
            f"./open-llm-leaderboard-results/{ds}_models-by-confidence.npy"
        )
        models_by_correctness = np.load(
            f"./open-llm-leaderboard-results/{ds}_models-by-correctness.npy"
        )
        ...
        all_datasets_configs.append(
            (num_source_models, ds, all_seen_idxs, all_unseen_idxs)
        )

        for technique_name, technique in techniques.items():
            logging.info(f"Running {technique_name} on {ds}")

            for num_medoids_fraction in tqdm(args.point_counts):

                num_medoids = max(
                    2, math.floor(num_medoids_fraction * len(all_seen_idxs[0]))
                )
                if args.same_points:
    ...
    with open(
        f"{results_dir}/configs-source-target-models_{arg_string}_{timestamp}.json", "w"
    ) as f:
        json.dump(
            [(args.benchmark, num_source_models, all_source_models, all_target_models)],
            f,
        )
    with open(
        f"{results_dir}/configs-seen-unseen-idxs_{arg_string}_{timestamp}.json", "w"
    ) as f:
...
def combine_subtasks_loop(
    ...
    for ds in args.datasets_to_run:
        all_data.append(
            np.load(f"./open-llm-leaderboard-results/{ds}_models-by-confidence.npy")
        )
        models_by_correctness.append(
            np.load(f"./open-llm-leaderboard-results/{ds}_models-by-correctness.npy")
        )
        ...
        if technique_name == "tinyBenchmarks":
            ...
            for num_medoids_fraction in args.point_counts:
                if args.same_points:
                    ...
                    all_num_medoids.append(
                        max(2, math.floor(num_medoids_fraction * len(all_seen_idxs[0])))
                    )
            # run the different trials in parallel on CPU
            start_time = time.time()
            pool_obj = multiprocessing.Pool()
            ...
            all_results.extend(
                [
                    single_medoid_result
                    for many_medoid_results in results
...
if __name__ == "__main__":
    ...
    possible_fixed_target_models = {
        "mmlu-pro_7b_instruct": [
            "Intel__neural-chat-7b-v3",
            "Deci__DeciLM-7B-instruct",
            "togethercomputer__Llama-2-7B-32K-Instruct",
            "internlm__internlm2_5-7b-chat",
            "google__gemma-7b-it",
            "mistralai__Mistral-7B-Instruct-v0.2",
            "ibm-granite__granite-7b-instruct",
            "deepseek-ai__deepseek-llm-7b-chat",
            "tiiuae__Falcon3-Mamba-7B-Instruct",
            ...
            "Qwen__Qwen2.5-7B-Instruct-1M",
            "Qwen__Qwen2-VL-7B-Instruct",
            "Qwen__Qwen2.5-Math-7B-Instruct",
            "mistralai__Mistral-7B-Instruct-v0.3",
            "togethercomputer__RedPajama-INCITE-7B-Instruct",
            "nvidia__AceInstruct-7B",
            "mistralai__Mistral-7B-Instruct-v0.1",
            "nvidia__AceMath-7B-Instruct",
            "argilla__notus-7b-v1",
            "mlabonne__NeuralBeagle14-7B",
            "HuggingFaceH4__zephyr-7b-gemma-v0.1",
            "mlabonne__AlphaMonarch-7B",
            "lmsys__vicuna-7b-v1.3",
            "CohereForAI__c4ai-command-r7b-12-2024",
            "NousResearch__Nous-Hermes-2-Mistral-7B-DPO",
            "ibm__merlinite-7b",
            "NousResearch__Nous-Hermes-llama-2-7b",
            "togethercomputer__RedPajama-INCITE-7B-Chat",
            "Intel__neural-chat-7b-v3-2",
            "Intel__neural-chat-7b-v3-3",
            "Intel__neural-chat-7b-v3-1",
            "cognitivecomputations__dolphin-2.9.2-qwen2-7b",
            "HuggingFaceH4__zephyr-7b-beta",
            "teknium__OpenHermes-7B",
            "Open-Orca__Mistral-7B-OpenOrca",
            "cognitivecomputations__dolphin-2.9.3-mistral-7B-32k",
            "berkeley-nest__Starling-LM-7B-alpha",
            "HuggingFaceH4__zephyr-7b-alpha",
            "databricks__dolly-v2-7b",
            "lmsys__vicuna-7b-v1.5",
            "teknium__CollectiveCognition-v1.1-Mistral-7B",
            "nvidia__AceMath-7B-RM",
            "togethercomputer__LLaMA-2-7B-32K",
            "microsoft__Orca-2-7b",
            "teknium__OpenHermes-2.5-Mistral-7B",
            "deepseek-ai__DeepSeek-R1-Distill-Qwen-7B",
            "NousResearch__Hermes-2-Pro-Mistral-7B",
        ],
        "mmlu-pro_7b_base": [
            "togethercomputer__RedPajama-INCITE-7B-Base",
            "google__gemma-7b",
            "deepseek-ai__deepseek-llm-7b-base",
            "tiiuae__Falcon3-Mamba-7B-Base",
            "Qwen__Qwen1.5-7B",
            "Qwen__Qwen2-7B",
            "allenai__OLMo-1.7-7B-hf",
            "ibm-granite__granite-7b-base",
            "Qwen__Qwen2.5-7B",
            "tiiuae__falcon-7b",
            "tiiuae__Falcon3-7B-Base",
            "mlabonne__Beyonder-4x7B-v3",
            "mistralai__Mistral-7B-v0.3",
            "mistralai__Mistral-7B-v0.1",
            "Qwen__Qwen2.5-Coder-7B",
            "mosaicml__mpt-7b",
            "mistral-community__Mistral-7B-v0.2",
            "Qwen__Qwen2-Math-7B",
            "NousResearch__Yarn-Mistral-7b-128k",
            "NousResearch__Yarn-Mistral-7b-64k",
            "allenai__OLMo-7B-hf",
            "meta-llama__Llama-2-7b-hf",
            "Deci__DeciLM-7B",
            "bigscience__bloom-7b1",
            "tiiuae__falcon-mamba-7b",
            "NousResearch__Yarn-Llama-2-7b-128k",
            "bigcode__starcoder2-7b",
            "Qwen__Qwen2.5-Math-7B",
        ],
        "mmlu-pro_8b_instruct": [
            "meta-llama__Llama-3.1-8B",
            "CohereForAI__aya-expanse-8b",
            "openchat__openchat-3.6-8b-20240522",
            "ibm-granite__granite-3.2-8b-instruct",
            "nvidia__Mistral-NeMo-Minitron-8B-Instruct",
            "mlabonne__OrpoLlama-3-8B",
            "mistralai__Ministral-8B-Instruct-2410",
            "gradientai__Llama-3-8B-Instruct-Gradient-1048k",
            "ibm-granite__granite-3.1-8b-instruct",
            "allenai__Llama-3.1-Tulu-3-8B",
            "mlabonne__Meta-Llama-3.1-8B-Instruct-abliterated",
            "meta-llama__Llama-3.1-8B-Instruct",
            "NousResearch__Hermes-3-Llama-3.1-8B",
            "NousResearch__Hermes-2-Pro-Llama-3-8B",
            "argilla-warehouse__Llama-3.1-8B-MagPie-Ultra",
            "Salesforce__LLaMA-3-8B-SFR-Iterative-DPO-R",
            "allenai__Llama-3.1-Tulu-3-8B-DPO",
            "TencentARC__LLaMA-Pro-8B-Instruct",
            "nvidia__OpenMath2-Llama3.1-8B",
            "cognitivecomputations__dolphin-2.9.4-llama3.1-8b",
            "allenai__Llama-3.1-Tulu-3-8B-SFT",
            "cognitivecomputations__Dolphin3.0-Llama3.1-8B",
            "internlm__internlm2_5-1_8b-chat",
            "ibm-granite__granite-3.0-8b-instruct",
            "meta-llama__Meta-Llama-3-8B-Instruct",
            "internlm__internlm2-chat-1_8b",
            "CohereForAI__aya-23-8B",
            "NousResearch__Hermes-2-Theta-Llama-3-8B",
            "mlabonne__Daredevil-8B",
            "mlabonne__NeuralDaredevil-8B-abliterated",
            "mlabonne__Daredevil-8B-abliterated",
            "mlabonne__ChimeraLlama-3-8B-v3",
            "mlabonne__ChimeraLlama-3-8B-v2",
            "abacusai__Llama-3-Smaug-8B",
        ],
        "mmlu-pro_8b_base": [
            "nvidia__Mistral-NeMo-Minitron-8B-Base",
            "ibm-granite__granite-3.1-8b-base",
            "meta-llama__Meta-Llama-3-8B",
            "cognitivecomputations__dolphin-2.9-llama3-8b",
            "TencentARC__Mistral_Pro_8B_v0.1",
            "nvidia__Minitron-8B-Base",
            "TencentARC__LLaMA-Pro-8B",
            "ibm-granite__granite-3.0-8b-base",
        ],
        "mmlu-pro_70b_instruct": [
            ...
            "allenai__Llama-3.1-Tulu-3-70B-SFT",
            "abacusai__Smaug-Llama-3-70B-Instruct-32K",
            "allenai__Llama-3.1-Tulu-3-70B-DPO",
        ...
        "mmlu-pro_70b_base": [
            ...
            "meta-llama__Llama-3.1-70B",
            "meta-llama__Llama-2-70b-hf",
        ...
        "gpqa_7b_instruct": [
            ...
            "mistralai__Mistral-7B-Instruct-v0.3",
            "allenai__OLMo-2-1124-7B-Instruct",
            "teknium__OpenHermes-2-Mistral-7B",
        ],
        "gpqa_7b_base": [
            "Deci__DeciLM-7B",
            "tiiuae__Falcon3-7B-Base",
            ...
            "togethercomputer__RedPajama-INCITE-7B-Base",
            "Qwen__Qwen2-Math-7B",
            "NousResearch__Yarn-Llama-2-7b-64k",
        ],
        "gpqa_70b_instruct": [
            "meta-llama__Llama-2-70b-chat-hf",
            "meta-llama__Llama-3.3-70B-Instruct",
    ...
    temp_all_data = np.load(
        f"./open-llm-leaderboard-results/{args.datasets_to_run[0]}_models-by-confidence.npy"
    )
    ...
    for num_source_models in args.num_source_models:
        ...
        if args.reuse_configs:
            with open(
                f"./configs-to-reuse/configs-source-target-models_{arg_string}.json",
                "r",
            ) as f:
                d = json.load(f)
            ...
            for _ in range(args.num_runs):
                if args.fixed_target_models:
                    with open(
                        f"./open-llm-leaderboard-results/{args.datasets_to_run[0]}_model-names-in-order.json",
                        "r",
                    ) as f:
                        all_model_names_in_order = json.load(f)
                    target_model_names = possible_fixed_target_models[
                        args.fixed_target_models
                    ]
                    target_models = [
                        all_model_names_in_order.index(model_name)
                        for model_name in target_model_names
                    ]
                else:
                    target_models = random.sample(range(num_models), k=50)
                source_models = random.sample(
                    list(set(range(num_models)).difference(target_models)),
                    num_source_models,
                )
        ...
        if args.reuse_configs:
            with open(
                f"./configs-to-reuse/configs-seen-unseen-idxs_{arg_string}.json", "r"
            ) as f:
